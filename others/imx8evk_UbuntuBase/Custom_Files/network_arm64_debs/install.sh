...
#
#  This creates rootfs/etc/network/interfaces.d/usb0:
#
/bin/bash -c "echo auto usb0 >          /etc/network/interfaces.d/usb0"
sed -i "\$aiface usb0 inet static"      /etc/network/interfaces.d/usb0
sed -i "\$a    address 192.168.5.2"     /etc/network/interfaces.d/usb0
sed -i "\$a    netmask 255.255.255.0"   /etc/network/interfaces.d/usb0
